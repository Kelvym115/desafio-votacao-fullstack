...
| Fork e PR | [Fork](https://github.com/Kelvym115/desafio-votacao-fullstack); PR em preparação |
...
- A CI executa os testes em Linux e exercita PostgreSQL e Docker, além da execução local com H2.
